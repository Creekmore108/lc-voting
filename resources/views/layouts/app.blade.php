    ...
    <body class="font-sans text-gray-900 text-sm bg-gray-background">
          ...
          <main class="container mx-auto max-w-custom flex flex-col md:flex-row">
              <div class="w-70 md:mr-5 mx-auto md:mx-0">
                  <div class="bg-white md:sticky md:top-8 border-2 border-blue border-opacity-50 rounded-xl mt-16">
                    ...
                    @else
                        ...
                        <a  href="{{ route('login') }}"
                            class="inline-block justify-center w-1/2 h-11 text-xs bg-blue font-semibold rounded-xl border border-blue hover:bg-blue-hover text-white transition duration-150 ease-in px-6 py-3">
                            Login
                        </a>
