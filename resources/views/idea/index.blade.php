<x-app-layout>
    <!--  Filters -->
    <div class="filters flex md:space-x-6 md:space-y-0 space-y-3 flex-col md:flex-row">
        ...
        <div class="idea-container hover:shadow-card transition duration-150 bg-white rounded-xl flex cursor-pointer">
            ...
            <div class="flex flex-col md:flex-row flex-1 px-2 py-6">
                ...
                <div class="w-full mx-4 flex flex-col justify-between">
                    <h4 class="text-xl font-semi-bold mt-2 md:mt-0">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center items-center justify-between mt-6">
                        <div class="flex text-gray-400 text-xs font-semibold space-x-2">
                        ...
                        <div class="flex items-center md:hidden mt-4 md:mt-0">
                            ...
                            <button 
                                class="w-20 bg-gray-200 border border-gray-200 hover:border-gray-400 transition duration-150 ease-in font-bold text-xxs uppercase 
